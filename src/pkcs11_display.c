...
enum_specs ck_mec_s[] = {
    ...
    CONSTANT(CKM_SHA224_RSA_PKCS),
    CONSTANT(CKM_SHA224_RSA_PKCS_PSS),
    ...
    CONSTANT(CKM_SHA224),
    CONSTANT(CKM_SHA224_HMAC),
    CONSTANT(CKM_SHA224_HMAC_GENERAL),
    ...
    CONSTANT(CKM_SHA224_KEY_DERIVATION),
    ...
    CONSTANT(CKM_AES_CTR),
    CONSTANT(CKM_AES_GCM),
    CONSTANT(CKM_AES_CCM),
    CONSTANT(CKM_AES_CTS),
